...
import Login from "./SygniwebPage/Login";
import SygniDashboard from "./SygniwebPage/SygniDashboard";
import StringDetails from "./SygniwebPage/CygniDashboard/StringDetails";

import CygniCardCom from "./SygniwebPage/CygniDashboard/CygniCardCom";
          ...
          <div style={{ flex: 1 }}>
            <Routes>
              ...
              <Route
                ...
                element={<Thermalalers />}
              />
              <Route
                path="/Alerts/ActiveAlerts/Chillers"
                element={<ChillerAlerts />}
              />
              ...
              <Route
                ...
                element={<ChillersDashBoardAll />}
              />
              <Route
                path="/Status/chillersStatus"
                element={<ChillersStatus />}
              />
              ...
              <Route
                path="/Controls/Renewable/Graph"
                element={<ControlsMainPage />}
              />
              <Route path="/WindDashboard" element={<WindDashboard />} />
              <Route path="/HashticCode" element={<HashticCode />} />
              <Route
                path="/MontlySlotegraphs"
                element={<MontlySlotegraphs />}
              />
              <Route path="/ActiveAlerts" element={<AlertDashboard />} />
              <Route path="/Cygni/login" element={<Login />} />
              <Route path="/Cygni/Dashboard" element={<SygniDashboard />} />
              <Route
                path="/Cygni/string/:stringId"
