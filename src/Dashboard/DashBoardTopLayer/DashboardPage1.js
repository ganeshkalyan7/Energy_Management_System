    ...
    <div className='maincontainer'>
      ...
      <Grid item xs={9}> 
        ...
        <div style={{border:"1px solid #EAEAEA",position:"relative",height:"70px",marginTop:"5%",marginLeft:"20px"}}/>
         ...
         <span className='DivRoot ' style={{color:"#69b931",fontSize:"36px",fontWeight:'600',fontFamily: 'Poppins',color:"#D24242"}}>4200 </span>
         <p className='TonsOfCo2Root' style={{color:"black",fontFamily: 'Poppins',fontSize:"14px",marginTop:"-4px",color:"#2b2b2b",fontWeight:"400"}}>kVA</p>
          </div>
          </Grid>
