...
function DashBoardChillers() {
  ...
  const [chillerTotalCoolingEnergyPhase1, setChillerTotalCoolingEnergyPhase1] =
    useState([]);
  ...
  useEffect(() => {
    axios
      .get(ChillerTotalCoolingPhase1_Api)
      .then((response) => {
        const dataresponse = response.data;
  ...
  for (let i = 0; i < thermal_IN_OUT.length; i++) {
    ...
    ThermalCondenserFlowrate.push(
      thermal_IN_OUT[i].Phase2avg_condenserLineFlowrate
    );
    avg_commonHeaderinletTemp.push(thermal_IN_OUT[i].Phase2EvaporatorInletTemp);
    avg_commonHeaderoutletTemp.push(
      thermal_IN_OUT[i].Phase2EvaporatorOutletTemp
    );
    avg_condenserLineInletTemp.push(
      thermal_IN_OUT[i].Phase2avg_condenserLineInletTemp
    );
    avg_condenserLineOutletTemp.push(
      thermal_IN_OUT[i].Phase2avg_condenserLineOutletTemp
    );
  }
  console.log(ThermalEvapuratorFlowrate, ThermalCondenserFlowrate);

  for (let i = 0; i < thermal_IN_OUT_Phase1.length; i++) {
    ThermalEvapuratorFlowrate_Phase1.push(
      thermal_IN_OUT_Phase1[i].Phase1EvaporatorFlowrate
    );
    ThermalCondenserFlowrate_Phase1.push(
      thermal_IN_OUT_Phase1[i].Phase1avg_condenserLineFlowrate
    );
    avg_commonHeaderinletTemp_Phase1.push(
      thermal_IN_OUT_Phase1[i].Phase1EvaporatorInletTemp
    );
    avg_commonHeaderoutletTemp_Phase1.push(
      thermal_IN_OUT_Phase1[i].Phase1EvaporatorOutletTemp
    );
    avg_condenserLineInletTemp_Phase1.push(
      thermal_IN_OUT_Phase1[i].Phase1avg_condenserLineInletTemp
    );
    avg_condenserLineOutletTemp_Phase1.push(
      thermal_IN_OUT_Phase1[i].Phase1avg_condenserLineOutletTemp
    );
  }
  ...
  const c1LoadingPercentage =
    C1_Loading[C1_Loading.length - 1] == 0 || null
      ? "OFF"
      : `C1 Loading ${C1_Loading[C1_Loading.length - 1]}%`;
  const c2LoadingPercentage =
    C2_Loading[C2_Loading.length - 1] == 0 || null
      ? "OFF"
      : `C2 Loading ${C2_Loading[C2_Loading.length - 1]}%`;
  const c3LoadingPercentage =
    C3_Loading[C3_Loading.length - 1] == 0 || null
      ? "OFF"
      : `C3 Loading ${C3_Loading[C3_Loading.length - 1]}%`;
  const c4LoadingPercentage =
    C4_Loading[C4_Loading.length - 1] == 0 || null
      ? "OFF"
      : `C4 Loading ${C4_Loading[C4_Loading.length - 1]}%`;
  const c5LoadingPercentage =
    C5_Loading[C5_Loading.length - 1] == 0 || null
      ? "OFF"
      : `C5 Loading ${C5_Loading[C5_Loading.length - 1]}%`;
  const c6LoadingPercentage =
    C6_Loading[C6_Loading.length - 1] == 0 || null
      ? "OFF"
      : `C6 Loading ${C6_Loading[C6_Loading.length - 1]}%`;
  const c7LoadingPercentage =
    C7_Loading[C7_Loading.length - 1] == 0 || null
      ? "OFF"
      : `C7 Loading ${C7_Loading[C7_Loading.length - 1]}%`;
  const c8LoadingPercentage =
    C8_Loading[C8_Loading.length - 1] == 0 || null
      ? "OFF"
      : `C8 Loading ${C8_Loading[C8_Loading.length - 1]}%`;
  ...
  for (let i = 0; i < chillerTotalCoolingEnergy.length; i++) {
    ChillerTotalCoolingEnergyDay =
      chillerTotalCoolingEnergy[i].Phase2TotalCoolingEnergy;
    //console.log(chillerTotalCoolingEnergy[i].Phase2TotalCoolingEnergy)
  }
  for (let i = 0; i < chillerTotalCoolingEnergyPhase1.length; i++) {
    ChillerTotalCoolingEnergyDayPhase1 =
      chillerTotalCoolingEnergyPhase1[i].Phase1TotalCoolingEnergy;
  ...
  for (let i = 0; i < totalElectricalEnergy.length; i++) {
    ChillerTotalElectricalEnergyDay =
      totalElectricalEnergy[i].TotalElectricalEnergy;
    //console.log(chillerTotalCoolingEnergy[i].Phase2TotalCoolingEnergy)
  }
    ...
    <div className="ChillersMaincontrainer" style={{ marginTop: "2%" }}>
      <div className="ChillersMaincontrainer-root">
        <div className="row" style={{ marginTop: "1%", marginBottom: "5%" }}>
          ...
          <div
            className="col-4"
            style={{ position: "relative", marginLeft: "0%", marginTop: "0px" }}
          >
            <img
              style={{
                height: "60px",
                ...
                >
                  ...
                  >
                    ...
                    >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  left: "0px",
                                  borderRadius: "10px",
                                  background: `linear-gradient(to top, #ff7338 ${
                                    C5_Loading[C5_Loading.length - 1]
                                  }%, ${fillColor} ${
                                    C5_Loading[C5_Loading.length - 1]
                                  }%)`,
                                  width: "51.68px",
                            ...
                            >
                              ...
                              >
                                {C5_cop[C5_cop.length - 1] == 0 || null
                                  ? "OFF"
                                  : C5_cop[C5_cop.length - 1]}
                              </div>
                              <div
                                style={{
                                  position: "absolute",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  borderRadius: "10px",
                                  background: `linear-gradient(to top, #ff7338 ${
                                    C6_Loading[C6_Loading.length - 1]
                                  }%, ${fillColor} ${
                                    C6_Loading[C6_Loading.length - 1]
                                  }%)`,
                                  width: "51.68px",
                            ...
                            >
                              ...
                              >
                                {C6_cop[C6_cop.length - 1] == 0 || null
                                  ? "OFF"
                                  : C6_cop[C6_cop.length - 1]}
                              </div>
                              <div
                                style={{
                                  position: "absolute",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  borderRadius: "10px",
                                  background: `linear-gradient(to top, #ff7338 ${
                                    C7_Loading[C7_Loading.length - 1]
                                  }%, ${fillColor} ${
                                    C7_Loading[C7_Loading.length - 1]
                                  }%)`,
                                  width: "51.68px",
                            ...
                            >
                              ...
                              >
                                {C7_cop[C7_cop.length - 1] == 0 || null
                                  ? "OFF"
                                  : C7_cop[C7_cop.length - 1]}
                              </div>
                              <div
                                style={{
                                  position: "absolute",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  borderRadius: "10px",
                                  background: `linear-gradient(to top, #ff7338 ${
                                    C8_Loading[C8_Loading.length - 1]
                                  }%, ${fillColor} ${
                                    C8_Loading[C8_Loading.length - 1]
                                  }%)`,
                                  width: "51.68px",
                            ...
                            >
                              ...
                              >
                                {C8_cop[C8_cop.length - 1] == 0 || null
                                  ? "OFF"
                                  : C8_cop[C8_cop.length - 1]}
                              </div>
                              <div
                                style={{
                                  position: "absolute",
                      ...
                      >
                        {/* 8 °C */}
                        {Math.trunc(
                          avg_commonHeaderinletTemp_Phase1[
                            avg_commonHeaderinletTemp_Phase1.length - 1
                          ]
                        )}
                        °C
                      </div>
                      ...
                      >
                        {Math.trunc(
                          avg_condenserLineInletTemp_Phase1[
                            avg_condenserLineInletTemp_Phase1.length - 1
                          ]
                        )}
                        °C
                        {/* 10 °C */}
                      ...
                      >
                        {Math.trunc(
                          avg_commonHeaderoutletTemp_Phase1[
                            avg_commonHeaderoutletTemp_Phase1.length - 1
                          ]
                        )}
                        °C
                      </div>
                      ...
                      >
                        {Math.trunc(
                          avg_condenserLineOutletTemp_Phase1[
                            avg_condenserLineOutletTemp_Phase1.length - 1
                          ]
                        )}
                        °C
                      </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {Math.trunc(
                          ThermalEvapuratorFlowrate_Phase1[
                            ThermalEvapuratorFlowrate_Phase1.length - 1
                          ]
                        )}
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        {Math.trunc(
                          ThermalCondenserFlowrate_Phase1[
                            ThermalCondenserFlowrate_Phase1.length - 1
                          ]
                        )}
                      </div>
                    </div>
                ...
                >
                  ...
                  >
                    ...
                    >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  borderRadius: "10px",
                                  background: `linear-gradient(to top, #ff7338 ${
                                    C1_Loading[C1_Loading.length - 1]
                                  }%, ${fillColor} ${
                                    C1_Loading[C1_Loading.length - 1]
                                  }%)`,
                                  width: "51.68px",
                            ...
                            >
                              ...
                              >
                                {C1_cop[C1_cop.length - 1] == 0 || null
                                  ? "OFF"
                                  : C1_cop[C1_cop.length - 1]}
                              </div>
                              <div
                                style={{
                                  position: "absolute",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  borderRadius: "10px",
                                  background: `linear-gradient(to top, #ff7338 ${
                                    C2_Loading[C2_Loading.length - 1]
                                  }%, ${fillColor} ${
                                    C2_Loading[C2_Loading.length - 1]
                                  }%)`,
                                  width: "51.68px",
                            ...
                            >
                              ...
                              >
                                {C2_cop[C2_cop.length - 1] == 0 || null
                                  ? "OFF"
                                  : C2_cop[C2_cop.length - 1]}
                              </div>
                              <div
                                style={{
                                  position: "absolute",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  borderRadius: "10px",
                                  background: `linear-gradient(to top, #ff7338 ${
                                    C3_Loading[C3_Loading.length - 1]
                                  }%, ${fillColor} ${
                                    C3_Loading[C3_Loading.length - 1]
                                  }%)`,
                                  width: "51.68px",
                            ...
                            >
                              ...
                              >
                                {C3_cop[C3_cop.length - 1] == 0 || null
                                  ? "OFF"
                                  : C3_cop[C3_cop.length - 1]}
                              </div>
                              <div
                                style={{
                                  position: "absolute",
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  borderRadius: "10px",
                                  background: `linear-gradient(to top, #ff7338 ${
                                    C4_Loading[C4_Loading.length - 1]
                                  }%, ${fillColor} ${
                                    C4_Loading[C4_Loading.length - 1]
                                  }%)`,
                                  width: "51.68px",
                            ...
                            >
                              ...
                              >
                                {C4_cop[C4_cop.length - 1] == 0 || null
                                  ? "OFF"
                                  : C4_cop[C4_cop.length - 1]}
                              </div>
                              <div
                                style={{
                                  position: "absolute",
                      ...
                      >
                        {/* 8 °C */}
                        {Math.trunc(
                          avg_commonHeaderinletTemp[
                            avg_commonHeaderinletTemp.length - 1
                          ]
                        )}
                        °C
                      </div>
                      ...
                      >
                        {Math.trunc(
                          avg_condenserLineInletTemp[
                            avg_condenserLineInletTemp.length - 1
                          ]
                        )}
                        °C
                      </div>
                      ...
                      >
                        {Math.trunc(
                          avg_commonHeaderoutletTemp[
                            avg_commonHeaderoutletTemp.length - 1
                          ]
                        )}
                        °C
                      </div>
                      ...
                      >
                        {Math.trunc(
                          avg_condenserLineOutletTemp[
                            avg_condenserLineOutletTemp.length - 1
                          ]
                        )}
                        °C
                      </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {Math.trunc(
                          ThermalEvapuratorFlowrate[
                            ThermalEvapuratorFlowrate.length - 1
                          ]
                        )}
                      </div>
                    </div>
                    ...
                    >
                      ...
                      >
                        {Math.trunc(
                          ThermalCondenserFlowrate[
                            ThermalCondenserFlowrate.length - 1
                          ]
                        )}
                      </div>
                    </div>
