...
function LTOCurrentVoltage() {
    ...
    const voltage_current=`http://${host}:5001/current_VS_voltage/LTOBattery`
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        ...
        try {
          ...
          const response = await axios.post(`http://${host}:5001/filtered/current_VS_voltage/LTOBattery`, {
