...
const currentGraph= {
  ...
  series: [   {
    ...
    },
    {
      ...
      //yAxis: 0,
      type: "line",
      color: '#e67700', // Change the color of the "Packsoc" line graph
      dashStyle: 'dash',
      marker: {
        enabled: false, // Disable markers for the series
      },
...

    {
      ...
      //yAxis: 0,
      type: "line",
      color: '#ffd43b', // Change the color of the "Packsoc" line graph
      dashStyle: 'dash',
      marker: {
        enabled: false, // Disable markers for the series
      },
...
<GridMaxDailyMonthly/>
  ...
  {/* <Grid item xs={12} sm={6} >
    ...
    <p style={{textAlign:"start",color:"#212529",fontSizeevenly:"20px",fontWeight:"600",marginLeft:"30px"}}>Daily Demand(kVA)</p>
    <div style={{width:"170px",marginLeft:"30px",position: "relative"}}>
    <DatePickers id="date" className="form-control" selected={singledayFilter} onChange={handlesingleDayFilterChange} placeholderText={currentdate} />  
