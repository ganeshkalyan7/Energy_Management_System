...
const dateValue = selectedDate ? new Date(selectedDate.getTime() - selectedDate.getTimezoneOffset() * 60000).toLocaleDateString('en-GB') : currentdate;
  return (
    <div style={{marginLeft:"80px",marginRight:"20px",marginTop:"90px"}}>
        <div>
        <div style={{display:"flex",justifyContent:"space-between"}}> 
    <p style={{textAlign:"start",color:"#212529",fontSize:"20px",fontWeight:"600",marginLeft:"40px"}}>RoofTop Solar</p>
