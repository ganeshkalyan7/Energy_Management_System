...
function WindDayMonth() {
  ...
  const WindDayGraph = {
    ...
    series: [
      {
        name: "Wind Energy  (kWh)",
        data:
          startDate == null && endDate == null
            ? WindDayData.map((val) => val.Energy)
            : WindDayDataDateFiltered.map((val) => val.Energy),
        //yAxis: 1,
        type: "column",
        color: "#D24242",
        marker: {
    ...
    xAxis: {
      ...
      categories:
        startDate == null && endDate == null
          ? WindDayData.map((val) => val.polledDate)
          : WindDayDataDateFiltered.map((val) => val.polledDate), // Use the pre-formatted timestamp from the API
    },
    plotOptions: {
      line: {
    ...
    series: [
      {
        ...
        data:
          selectedstartYear == null && selectedendYear == null
            ? WindMontData.map((val) => val.Energy)
            : WindMontDataDateFiltered.map((val) => val.Energy),
        //yAxis: 1,
        type: "column",
        color: "#D24242",
        marker: {
  ...
  return (
    <div
      style={{ marginLeft: "90px", marginRight: "40px", marginTop: "100px" }}
    >
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        ...
        <div
          ...
          style={{ width: "170px", marginTop: "0px", marginLeft: "0px" }}
        >
